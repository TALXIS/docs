...
# Introduction
Welcome to the talxis user documentation! We are glad that you want to learn how to use the application in your organization or you are just interested in business applications. 
...
- **Learn how to work with contacts and companies(accounts)**
    ...
    - Use accounts to manage companies (_in-progress_)
